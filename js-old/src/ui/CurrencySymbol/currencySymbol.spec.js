...
describe('ui/CurrencySymbol', () => {
  ...
  describe('currencies', () => {
    ...
    it('renders NUKO for nekonium', () => {
      expect(render('nekonium').text()).equal('NUKO');
    });


    it('renders ETH as default', () => {
      expect(render('somethingElse').text()).equal('NUKO');
    });
  });
  ...
  describe('renderSymbol', () => {
    ...
    it('render ETH as default', () => {
      expect(render().instance().renderSymbol()).equal('NUKO');
    });
    ...
    it('render NUKO', () => {
      expect(render('nekonium').instance().renderSymbol()).equal('NUKO');
    });
